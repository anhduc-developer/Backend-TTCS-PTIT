...
public class OpenAPIConfig {
    ...
    private Contact createContact() {
        return new Contact()
                ...
                .name("Anh Đức Mai")
                .url("https://github.com/anhduc-developer");
    }
    ...
    private Info createApiInfo() {
        return new Info()
                ...
                .termsOfService("https://github.com/anhduc-developer")
    ...
    public OpenAPI myOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List.of(
                        ...
                        createServer("https://github.com/anhduc-developer", "Server URL in Production environment")))
